...
class TestFreshMigration:
    ...
    def test_fresh_db_upgrade_from_scratch(self, tmp_path):
        ...
        expected_tables = {"instances", "projects", "tasks", "log_entries", "worktrees", "global_settings", "secrets", "tags", "discussions", "discussion_messages", "discussion_agents", "discussion_events", "quick_phrases", "monitor_sessions", "monitor_checks", "pr_reviews", "monitored_repos"}
